...
def serve_layout():
    return dbc.Container(fluid = True,
                children = [
                    dbc.Row([
                        dbc.Col([
                                    dbc.NavbarSimple(
                                        ...
                                        dark=True,
                                        fluid = True,
                                        class_name = 'd-flex w-100 justify-content-start'
                                    ),
                                    ...
                                    dbc.Row([
                                        dbc.Col(
                                            ["Object Statistics"],
                                            style = {'height':'10vh'},
                                            class_name = "d-flex text-uppercase fs-2 fw-bold border border-info align-items-center justify-content-center"
                                        ),
                                    ...
                                    dbc.Row([
                                        dbc.Col(
                                            ["Data Filters"],
                                            style = {'height':'8vh'},
                                            class_name = "d-flex fs-5 fw-bold text-uppercase border border-info align-items-center justify-content-start"
                                        ),
                                    ],class_name= "d-flex w-100 justify-content-center align-items-center border border-secondary"),
                                    ...
                                    dbc.Row([
                                        ...
                                        dbc.Col([
                                            dbc.Card([
                                                dbc.Row(["Select source:"],style = {'height':'6vh',}, class_name = 'd-flex justify-content-start p-1 ps-2'),
                                                dbc.Row([
                                                    dbc.InputGroup(
                                                        [
                                        ...
                                        dbc.Col([
                                            dbc.Card([
                                                dbc.Row(["Filter objects:"],style = {'height':'6vh',}, class_name = 'd-flex justify-content-start p-1 ps-2'),
                                                dbc.Row([
                                                    dbc.InputGroup(
                                                        [
                                        ...
                                        dbc.Col([
                                            dbc.Card([
                                                dbc.Row(["Setup analysis:"],style = {'height':'6vh',}, class_name = 'd-flex justify-content-start p-1 ps-2'),
                                                dbc.Row([
                                                    dbc.InputGroup(
                                                        [
                                    ...
                                    dbc.Row([
                                        ...
                                        ], className = "d-flex-inline p-0 ms-2 border border-secondary align-content-around justify-content-center"),
                                        ########################
                                        dbc.Col([
                                            ...
                                            dbc.Row([
                                                dbc.Col([
                                                    ...
                                                    ], class_name = 'd-flex border-start border-info border-5 m-0 p-0'),
                                                ],class_name = 'd-flex h-100 align-items-center justify-content-center m-0 p-0')
                                            ],style = {'height':'35vh'},className = 'd-flex align-items-center justify-content-center border border-info m-0 p-0'),
                                            ...
                                            dbc.Row([
                                                dbc.Col([
                                                    ...
                                                    ], class_name = 'd-flex border-start border-primary border-5 m-0 p-0'),
                                                ],class_name = 'd-flex h-100 align-items-center justify-content-center m-0 p-0')
                                            ],style = {'height':'35vh'},className = 'd-flex align-items-center justify-content-center border border-danger m-0 p-0'),
                                        
                                        ], class_name = "d-flex-inline h-100 w-50 flex-wrap justify-content-between align-content-center border border-primary p-0 m-0"),
                                        ########################
                                    ],style = {'height':'70vh',}, class_name = 'd-flex w-100 border border-success justify-content-evenly align-content-evenly p-0 m-0'),
                    ...
                    ], style={'position':'absolute','top':-60,'width':'95vw', 'padding':'0px', 'margin':'0px'}, className = "shadow-lg border border-danger d-flex justify-content-center"),                
